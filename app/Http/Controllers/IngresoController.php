...
class IngresoController extends Controller
{
   ...
   public function create()
   {
         ...
         ->select(DB::raw('CONCAT( art.codigo, art.nombre, art.contenido, art.bodega) AS articulo'), 'art.idarticulo') //->select(DB::raw('CONCAT("REF #",art.codigo, "-- ", art.nombre, "-- ", art.contenido, "--  Bodega ", art.bodega) AS articulo'), 'art.idarticulo')
