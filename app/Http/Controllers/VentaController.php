...
class VentaController extends Controller
{
   ...
   public function create()
   {
   		...
   		$articulos = DB::table('articulo as art')
            ...
            ->select(DB::raw('CONCAT(\'REF # \', art.codigo, \' -- \', art.contenido, \' -- \', art.nombre, \' -- BODEGA  \', art.bodega, \' -- \', art.stock) AS articulo'), 'art.idarticulo', 'art.stock',DB::raw('art.estado ,COUNT(*) as totalp')) // ->select(DB::raw('CONCAT("REF #", art.nombre, " -- Bodega ", art.bodega, "-- ", art.stock) AS articulo'), 'art.idarticulo', 'art.stock',DB::raw('art.estado ,COUNT(*) as totalp'))
