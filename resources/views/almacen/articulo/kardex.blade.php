...
<div class="row">
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
    <h3>Kardex del producto : <strong>" {{ $articulo->nombre }} - REF # {{ $articulo->codigo }} - {{ $articulo->contenido }}- BODEGA {{ $articulo->bodega }}" - </strong>  Existencia Actual :  <strong> {{ $articulo->stock }}</strong> </h3> 
  </div>
</div>
...
<div class="row">
  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <div class="table-responsive bg-success">
      <table id="ttTable" class="table table-striped table-bordered table-condensed table-hover " id="kardex_salida" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <!--<td><input type="checkbox" value="" id="" name="check" /> Si<br/>
                <input type="checkbox" value="" id="" name="check"  /> No <br/>
            </td>-->
