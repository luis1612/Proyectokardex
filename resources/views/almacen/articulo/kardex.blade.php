...
<div class="row">
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
    <h3>Kardex del producto : <strong>" {{ $articulo->nombre }} - {{ $articulo->codigo }} - {{ $articulo->contenido }}-<H3> Bodega  </H3> {{ $articulo->bodega }}" - </strong>  Existencia Actual :  <strong> {{ $articulo->stock }}</strong> </h3> 
  </div>
</div>
